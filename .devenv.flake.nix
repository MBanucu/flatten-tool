{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/michi/dev/flatten-tool";
  project_input_ref = "path:/home/michi/dev/flatten-tool";
  devenv_dotfile = "/home/michi/dev/flatten-tool/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-87b2a28";
  ...
  hostname = "nixos";
  username = "michi";
  git_root = "/home/michi/dev/flatten-tool";
  secretspec = null;
};
    in
    {
