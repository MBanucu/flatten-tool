...
This project was created using `bun init` in bun v1.3.8. [Bun](https://bun.com) is a fast all-in-one JavaScript runtime.</content>
<parameter name="filePath">/home/michi/dev/flatten-tool/README.md